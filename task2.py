...
#print(teamData)
for  i in games: #Problem- Find the home team and assign the score to the dictionary inside the dictionary
        home = games[games.index(i)]["home"]
        ...
        teamData[home]["goalsFor"] += games[games.index(i)]["homeScore"]
        teamData[home]["goalsAgainst"] += games[games.index(i)]["awayScore"]
print(teamData)
